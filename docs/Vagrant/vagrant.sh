...
echo "CREATE DATABASE IF NOT EXISTS \`anton-am\` CHARACTER SET utf8 COLLATE utf8_unicode_ci" | mysql -uroot -proot

sudo php /var/www/console/yii app/setup --interactive=0
